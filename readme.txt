...
25 User CSS Classes
  ...
  - bg-base         = background-color: #222222
  - bg-base-medium  = background-color: #808080
  - bg-base-light   = background-color: #c0c0c0
  - bg-base-xlight  = background-color: #dcdcdc
  - bg-base-xxlight = background-color: #f5f5f5
...
When the sticky header kicks in the logo is reduced to 50 pixels in height.
